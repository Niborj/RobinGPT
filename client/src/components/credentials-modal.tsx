...
import { Key, Mail, Globe, Info, Server, Shield, Palette, Type, ImageIcon, Upload, Trash2, RotateCcw } from "lucide-react";
...
export function CredentialsModal() {
  const { hasCredentials, setCredentials } = useCredentials();
  ...
  const onSubmit = (data: CredentialsFormData) => {
    try {
      ...
      setIsOpen(false);
      toast({
        title: t('chat.credentialsSaved'),
        description: t('chat.credentialsSavedDesc', { appName }),
      });
    } catch (error) {
      toast({
        title: "Error",
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-[520px] max-h-[85vh] flex flex-col" data-testid="dialog-credentials">
        <DialogHeader>
          <DialogTitle className="text-xl">
            {t('chat.credsWelcomeTitle', { appName })}
          </DialogTitle>
          <DialogDescription>
            {t('chat.credsWelcomeDesc')}
          </DialogDescription>
        </DialogHeader>

        <div className="rounded-md bg-blue-50 dark:bg-blue-950 p-3 text-sm">
          <p className="font-medium text-blue-900 dark:text-blue-100 mb-1">
            {t('chat.credsFindTitle')}
          </p>
          <p className="text-blue-800 dark:text-blue-200">
            {t('chat.credsFindDesc')}
          </p>
        </div>

        <Tabs defaultValue="security" className="flex-1 min-h-0">
          <TabsList className="w-full grid grid-cols-3">
            <TabsTrigger value="security" className="gap-1.5" data-testid="tab-modal-security">
              <Shield className="w-3.5 h-3.5" />
              <span>{t('chat.tabSecurity')}</span>
            </TabsTrigger>
            <TabsTrigger value="llm" className="gap-1.5" data-testid="tab-modal-llm">
              <Server className="w-3.5 h-3.5" />
              <span>{t('chat.tabLlm')}</span>
            </TabsTrigger>
            <TabsTrigger value="branding" className="gap-1.5" data-testid="tab-modal-branding">
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input
                                ...
                                placeholder="sk-..."
                                className="pl-9"
                                data-testid="input-modal-openai-api-key"
                              />
                            </div>
                          </FormControl>
                          <FormDescription>
                ...
                <TabsContent value="branding" className="mt-0 space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      data-testid="input-modal-branding-name"
                    />
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex gap-2 flex-wrap">
                        <input
                          ...
                          data-testid="input-modal-branding-logo-file"
                        />
                        <Button
                          type="button"
                          variant="outline"
                          ...
                          data-testid="button-modal-upload-logo"
                        >
                        ...
                        {branding.logoUrl && (
                          <Button
                            ...
                            data-testid="button-modal-remove-logo"
                          >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                      <input
                        ...
                        data-testid="input-modal-branding-color"
                      />
                      {branding.primaryColor && (
                        <Button
                          ...
                          data-testid="button-modal-reset-color"
                        >
                  ...
                  {isCustomized && (
                    <div className="flex justify-end pt-2">
                      <Button
                        ...
                        data-testid="button-modal-reset-branding"
                      >
                        <RotateCcw className="w-4 h-4 mr-2" />
                        {t("branding.resetDefaults")}
                      </Button>
